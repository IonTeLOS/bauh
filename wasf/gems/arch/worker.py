...
from wasf.commons.system import new_root_subprocess, ProcessHandler
from wasf.gems.arch import pacman, disk, CUSTOM_MAKEPKG_FILE, CONFIG_DIR, AUR_INDEX_FILE, get_icon_path, database, \
    mirrors, ARCH_CACHE_PATH, AUR_INDEX_TS_FILE, aur
from wasf.gems.arch.aur import URL_INDEX
    ...
    def optimize(self):
        ...
        if os.path.exists(GLOBAL_MAKEPKG):
            ...
            if custom_makepkg and optimizations:
                generated_by = '# <generated by wasf>\n'
