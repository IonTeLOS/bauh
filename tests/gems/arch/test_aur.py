...
from waffles.gems.arch import aur
...
class AURModuleTest(TestCase):
    ...
    def test_map_srcinfo__only_one_pkgname(self):
        expected_fields = {
            ...
            'pkgver': '0.1',
            'pkgrel': '2',
            'url': 'https://github.com/iontelos/waffles',
            'arch': 'any',
            'license': 'zlib/libpng',
            ...
            'source': ['https://github.com/iontelos/waffles/archive/0.1.tar.gz'],
        ...
        with open(FILE_DIR + '/resources/waffles_srcinfo') as f:
            srcinfo = f.read()

        res = aur.map_srcinfo(srcinfo, 'waffles')
    ...
    def test_map_srcinfo__one_name__only_specific_fields(self):
        ...
        res = aur.map_srcinfo(srcinfo, 'waffles', fields={*expected_fields.keys()})
